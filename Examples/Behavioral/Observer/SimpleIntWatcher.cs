...
namespace CSC360_FinalProject.Examples.Behavioral.Observer {
	/// <summary>
	/// A simple watcher that just prints the value of the watched
	/// <c>int</c> any time it changes.
	/// </summary>
	public class SimpleIntWatcher : IIntWatcher {
		/// <summary>
		...
		public void ValueUpdated(int value) {
			Console.WriteLine($"Value has been updated! Value is: {value}");
		}
	}
}
